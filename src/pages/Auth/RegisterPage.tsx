...
const RegisterPage: React.FC = () => {
    ...
    return (
        <div className="card bg-white dark:bg-gray-800 shadow-xl w-full max-w-md transform-gpu rounded-xl
            ...
            <div className="card-body p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        ...
                        className="btn btn-primary w-full gap-2 transform transition-all duration-300
